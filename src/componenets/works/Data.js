export const Data = [
	...
	},
	{
		...
		title: 'Taskify',
		description:
			'Taskify is a task scheduling tool built with <strong>Symfony</strong>, <strong>TypeScript</strong>, <strong>PHP</strong>, and <strong>Tailwind</strong>. It lets users organize tasks, set due dates, and receive automated email reminders.',
